...
if __name__ == '__main__':
    ...
    parser.add_argument('--language_code', default='en-US', type=str)
    # Enhanced models are only available to projects that
    # opt into audio data collection.
    parser.add_argument('--enhanced', default=False, type=bool)
    # A model needs to be specified when using the enhanced model.
    parser.add_argument('--model', default='phone_call', type=str)
